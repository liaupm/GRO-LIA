...
class GenPlasmid {
	...
	public:
        ...
        /* CONSTRUCTOR */
        GenPlasmid(std::string id, GenListPlasmid* parent, GenPlasmid* enviroment_plasmid); // New plasmid with ID.
        GenPlasmid(std::string id, std::string name, GenListPlasmid* parent, GenPlasmid* enviroment_plasmid);// New plasmid with ID and name.
