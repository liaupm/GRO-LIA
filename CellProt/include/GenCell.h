...
class GenCell{
	private:
		...
		float time;//---AITOR
	    float sigmaAct;//---AITOR
	    float sigmaDeact;//---AITOR
	    erreenege *rng;
	   
	public:
        /* CONSTRUCTOR */
        /*GenCell(std::string name, int state, int type, GenOperon* parent, GenPlasmid* enviroment_plasmid, int); // New gen with name and initial state.
        GenCell(std::string name, int type, GenOperon* parent, GenPlasmid* enviroment_plasmid, int); // New gen with name.
        GenCell(std::string name, int state, std::string target, int type, GenOperon* parent, GenPlasmid* enviroment_plasmid, int); // New gen with name and initial state.
        GenCell(std::string name, std::string target, int type, GenOperon* parent, GenPlasmid* enviroment_plasmid, int); // New gen with name.
        GenCell(std::string name, int type, int); // New gen with type.*/
        GenCell(std::string name, int state, int type, GenOperon* parent, GenPlasmid* enviroment_plasmid,float time_act,float time_deact); // New gen with name and initial state.
        GenCell(std::string name, int type, GenOperon* parent, GenPlasmid* enviroment_plasmid,float time_act,float time_deact); // New gen with name.
        GenCell(std::string name, int state, std::string target, int type, GenOperon* parent, GenPlasmid* enviroment_plasmid,float time_act,float time_deact); // New gen with name and initial state.
        GenCell(std::string name, std::string target, int type, GenOperon* parent, GenPlasmid* enviroment_plasmid,float time_act,float time_deact); // New gen with name.
